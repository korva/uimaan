...
Uimaan is currently available on Nokia Store for Symbian^3 and MeeGo Harmattan.
The app is implemented using Qt and QML.
...
Project should build in Qt SDK Creator 1.2.x and be deployable to simulator, Symbian and Harmattan.
...
-------
    ...
    Uimaan - Find places to swim in Finland!
    Copyright (C) 2012  Jaakko Koskenkorva
